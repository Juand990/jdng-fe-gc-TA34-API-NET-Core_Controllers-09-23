...
namespace TA34_04.Controllers
{
    ...
    public class ReservasController : ControllerBase
    {
        ...
        public ReservasController(LaboratorioContext context)
        {
            _context = context;
        }
        ...
        public async Task<ActionResult<Reserva>> PostReserva(Reserva reserva)
        {
          if (_context.Reserva == null)
          {
              return Problem("Entity set 'LaboratorioContext.Reserva'  is null.");
          }
            ...
            {
                if (ReservaExists(reserva.NumSerieEqu))
                {
                    return Conflict();
                }
                else
            ...
            return CreatedAtAction("GetReserva", new { id = reserva.NumSerieEqu }, reserva);
        }
        ...
        {
            return (_context.Reserva?.Any(e => e.NumSerieEqu == id)).GetValueOrDefault();
        }
    }
}
